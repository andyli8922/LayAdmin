...
function (e) {
    ...
    F.prototype.setInit = function (e) {
        ...
        "width" === e ? i.clientWidth : void layui.each(i.cols,
        function (e, a) {
            layui.each(a,
            function (l, n) {
    ...
    F.prototype.setColsWidth = function () {
        ...
        e.eachCols(function (i, a) {
            ...
            a.colGroup || a.hide || (0 === a.width ? e.getCssRule(t.index + "-" + a.key,
            function (e) {
    ...
    F.prototype.events = function () {
                ...
                case "LAYTABLE_COLS":
                    s({
                        ...
                        function () {
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)",
                            function (e) {
                                var i = t(e.elem),
                                l = this.checked,
                                n = i.data("key"),
        ...
        a.elem.on("click", 'input[lay-type="layTableRadio"]+',
        function () {
            var e = t(this).prev(),
            i = e[0].checked,
            l = d.cache[a.key],
    ...
    d.reload = function (e, i) {
        i = i || {};
        var a = s(e);
        if (a) return i.data && i.data.constructor === Array && delete a.data,
        d.render(t.extend(!0, {},
        a, i))
    },
    d.render = function (e) {
